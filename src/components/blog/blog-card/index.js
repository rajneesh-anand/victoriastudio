...
const BlogCard = ({ data }) => {
  ...
  return (
    <section>   
        ...
        style={{backgroundImage: data.image ? `url(${data.image})` : "url('https://source.unsplash.com/600x900/?tech,street')", cursor:"pointer" }}
        >
                 ...
                 <div className="card-footer">
                    <div className="media">
                      ...
                      <div className="media-body">
                        ...
                        <small className="my-0 text-dark d-block">Author / Blogger </small>
                      </div>
                    </div>  
