              ...
              <div className="department-content">
                ...
                <div className="team-single">
                  ...
                  <div className="membr-info">
                    ...
                    <div className="desc">
                      <p>
                        Dr. Genoveva Leannon received his medical degree from
                        University of Minnesota Medical School and has been in
                        practice between 6-10 years.
                      </p>
                      <ul>
                        <li>
                  ...
                  <div className="thumb">
                    <img
                      src={process.env.PUBLIC_URL + "/img/photos/doctor-02.png"}
                      alt="hope"
                    />
                  </div>
                </div>
                ...
                <div className="case-area">
                  ...
                  <Swiper className="case-slider-container" {...swiperOption}>
                    {HomeData[8].cases &&
                      HomeData[8].cases.map((single, key) => {
                        return (
                          <SwiperSlide key={key}>
                            <CasesItem key={key} data={single} />
                          </SwiperSlide>
                        );
                      })}
                  </Swiper>
